...
### Fixed
- Make `user_name` optional in `SlackMessage` model (default: empty string, falls back to `user_id`)
- Fixes validation errors when scli exports contain messages from deactivated or unresolved users
